...
<body style="font-size: 12px;">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9">
				<div class="legend">Gestion des connexions base de données</div>
				...
				<div class="row" style="margin-left: 10px;">
					<div class="span2">
						<a class="btn btn-mini" href="connection_add" > <i class="icon-plus-sign"></i>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th>Type de la base de données</th>
					...
					<tbody>
						<c:forEach var="connection" items="${connectionList}">
							<tr>
								...
								<td>${connection.sgbdType}</td>
								<td>${connection.username}</td>
								<td>${connection.password}</td>
								<td>${connection.connection_url}</td>
