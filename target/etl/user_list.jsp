...
<body style="font-size: 12px;">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9">
				<div class="legend">Gestion des utilisateurs</div>
				...
				<div class="row" style="margin-left: 10px;">
					<div class="span2">
						<a class="btn btn-mini" href="user_add"> <i
							class="icon-plus-sign"></i> Ajouter un utilisateur
						</a>
					</div>
				</div>
