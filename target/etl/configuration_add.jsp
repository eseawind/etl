...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9">
				<div class="legend">Ajouter une configuration</div>
						...
						<div class="span8">
							...
							<div class="control-group">
								...
								<div class="controls" style="margin-left: 200px;">
									...
									<form:input path="display_field_separator"
										cssClass="input-mini" cssStyle="margin-left:20px;"
										id="carac_sep_colonne" />
								</div>
							</div>
							<div class="control-group">
