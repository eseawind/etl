...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9">
				<div class="legend">Vérification</div>
				<form:form cssClass="form-horizontal" commandName="verificationBean"
					...
					<fieldset>
						...
						<div class="row" style="margin-bottom: 15px; margin-left: 0;">
							<span class="badge">1</span> <span>Choisir la
								configuration et la structure de données à utiliser</span>
						</div>
						...
						<div class="row" style="margin-bottom: 15px; margin-left: 0;">
							<span class="badge badge-success">2</span> <span>Sélectionner
					...
					<div class="form-actions" style="padding-left: 900px;">
						<input class="btn btn-primary" type="submit" name="submit"
							value="Commencer la vérification »" id="btn-import_next_step" />
					</div>
				</form:form>
			</div>
		</div>
