...
.ms-container {
	background: url("../img/switch.png") no-repeat scroll 312px 80px
		transparent;
}
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<form:form cssClass="form-horizontal" commandName="userBean"
					...
					<fieldset>
						<div class="legend">Modifier un utilisateur</div>
						...
						<div class="control-group">
							<label class="control-label-wide">Prénom:</label>
							<div class="controls-wide">
						...
						<div class="well span8"
							...
							<div
								...
								<form:select id="multiselect" path="selected_droits_utilisateurs">
									<form:options items="${userBean.droits_utilisateurs}"
										selected='selected' />
									<form:options items="${userBean.display_droits_utilisateurs}" />
