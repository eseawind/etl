	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<div class="alert alert-success" style="margin-top: 20px;"><span class="label label-success">Succès</span> 
				<strong style="margin-left: 20px;">Opération terminé avec succès</strong></div>
			</div>
		</div>
	</div>
</body>
