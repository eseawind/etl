...
<body style="font-size: 12px;">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9">
				<div class="legend">Gestion des droits utilisateurs</div>
				...
				<div class="row" style="margin-left: 10px;">
					<div class="span2">
						<a class="btn btn-mini" href="user_right_add"> <i
							class="icon-plus-sign"></i> Ajouter un droit utilisateur
						</a>
					</div>
				</div>
				<table class="table table-bordered" style="width: 640px;">
					...
					<tbody>
						<c:forEach var="user_right" items="${userRightList}">
							<tr>
								<td>${user_right.label}</td>
								<td width = 120px;><a class="btn btn-mini btn-info"
									href="${user_right.details_url}"> <i
										class="icon-info-sign icon-white"></i> Plus de détails &#187;
								</a></td>
								<td style="width: 80px;"><a class="btn btn-mini"
									href="${user_right.edit_url}"> <i class="icon-edit"></i>
										Modifier
								</a></td>
								<td style="width: 90px;"><a class="btn btn-mini btn-danger remove-link"
									href="${user_right.delete_url}"> <i
